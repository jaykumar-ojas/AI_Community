// ShowGeneratedContent.jsx - Updated with Code Preview
...
import { CodePreview } from "../../ui/CodePreview"; // Import the CodePreview component
...
const ShowAiText = ({ aiText, modelInfo, isStreaming = false }) => {
  ...
  codeBlocks.forEach((block) => {
    textWithoutCode = textWithoutCode.replace(block.fullMatch, `__CODE_BLOCK_${block.index}__`);
  });
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-[80%] bg-white font-poppins dark:bg-nav_hover2 px-4 py-3 rounded-2xl shadow-md text-sm text-gray-800 dark:text-low_text border dark:border-gray-700 border-gray-300">
        {/* Render text content */}
        <div className="prose prose-sm text-gray-800 dark:text-gray-200">
          {textWithoutCode.split(/__CODE_BLOCK_(\d+)__/).map((part, idx) => {
...
const ImageSkeleton = () => (
  <div className="flex justify-start">
    <div className="max-w-[50%] bg-nav_hover2 rounded-2xl shadow-md overflow-hidden border border-gray-700 w-full">
