    ...
    <div>
      <div className="relative flex w-full items-center gap-2 mb-2">
        <div className="flex gap-2 text-center justify-center">
          <h1 className="sticky text-md md:text-xl w-full font-semibold text-text_comment tracking-wide">
            Comments
          </h1>
          <div className="w-4 h-4 mt-1 md:mt-2 text-[10px] md:text-xs font-medium border border-time_header text-time_header bg-bg_scroll rounded">
            {comments?.length || 0}
          </div>
        </div>
      </div>
